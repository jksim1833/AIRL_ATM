...
class LuggageAnalyzer:
    def __init__(self):
        ...
        self.prompt_path = self.base_path / "chain1_prompt" / "ver3_gemini.txt"
        self.image_base_path = self.base_path / "chain1_image"
        self.output_base_path = self.base_path / "chain1_out" / "ver3" / "gemini"
    ...
    def _create_chain(self, model_name: str):
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            ("human", [
                {"type": "text", "text": "이 이미지를 분석해서 다음 JSON 스키마에 맞춰 정확히 출력해주세요:\n\n{format_instructions}\n\n**오직 JSON만 출력하고 다른 설명은 절대 포함하지 마세요.**"},
