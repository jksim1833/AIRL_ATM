...
ROOT = Path(__file__).resolve().parent          # tetris_t1/tetris/main_chain
TETRIS_ROOT = ROOT.parent                       # tetris_t1/tetris  
SECRETS_JSON = TETRIS_ROOT.parent.parent / "tetris_secrets.json"
