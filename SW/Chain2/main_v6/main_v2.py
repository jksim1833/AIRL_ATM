...
# -*- coding: utf-8 -*-
"""
최적화된 Gemini 차량 좌석 레이아웃 선택 시스템 v2.3
- 파일 생성 없이 기존 파일 경로 사용 또는 기본값 사용
- 안정성 및 디버깅 용이성 향상
"""
...
class OptimizedGeminiSelector:
    ...
    def __init__(self, 
                 ...
                 input_image_path: str = "", # 기본값을 빈 문자열로 변경
    ...
    def _load_file_safely(self, file_path: str, is_json: bool = False, default_content: Any = None) -> Any:
        ...
        # 파일 경로가 유효하지 않거나 존재하지 않을 경우 기본값 반환
...
def main():
    ...
    try:
        print("=" * 60)
        print("최적화된 차량 좌석 레이아웃 선택 시스템 v2.3")
        print("=" * 60)
        
        # 파일 생성 코드를 제거하여 기존 파일을 사용하도록 변경
