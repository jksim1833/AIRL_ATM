Imagine you are a planar that can move seat location by code you provide after, and you’re positioned in the center of a inside car. A person who gives some direction about seat to you, than your objective is to be print out the appropriate setting status for each chair.

The seats has 3 type of setting. You can assume that the following setting are available:
...
Additional points to consider when giving your answer:
 - Your reponses should be informative, logical and actionable.
...
Here's an example of an depicts of seat setting:
