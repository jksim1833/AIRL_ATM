...
class SeatControlChatbot:
        ...
        while True:
            try:
                ...
                if choice == 1:
                    ...
                    print("✅ Google Gemini 2.0 Flash 선택됨")
                    break
                elif choice == 2:
                    self.api_type = 'gpt'
    ...
    def run_scenario_test(self, scenario_txt_path, scenario_img_path,
                         ...
                         basic_prompt_path="SW/Chain2/main_v2/source/chain2_basic.txt",
                         option_list_path="SW/Chain2/main_v2/source/chain2_option_list.json"):
        """시나리오 테스트 실행"""
        try:
            print("=" * 50)
...
예: "옵션 3번 선택: ..." 형태로 답변해주세요."""
    ...
    def run_chatbot(self, sysprompt_path="SW/Chain2/main_v2/source/chain2_system.txt",
                   basic_prompt_path="SW/Chain2/main_v2/source/chain2_basic.txt",
                   option_list_path="SW/Chain2/main_v2/source/chain2_option_list.json"):
        """기존 챗봇 모드 (채팅 초기화 제거됨)"""
        try:
...
def main():
    ...
    parser.add_argument("--scenario-txt", type=str, 
                       default="SW/Chain2/main_v2/scenarios/test1.txt",
                       help="시나리오 텍스트 파일 경로")
    parser.add_argument("--scenario-img", type=str,
                       default="SW/Chain2/main_v2/scenarios/test1.jpg",
                       help="시나리오 이미지 파일 경로")
